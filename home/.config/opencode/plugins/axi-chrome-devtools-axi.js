...
const command = "chrome-devtools-axi";
const marker = "chrome-devtools-axi";
const ambientHeader = "## AXI ambient context: chrome-devtools-axi";
...
export const AxiChromeDevtoolsAxiAmbientContextPlugin = async ({ directory }) => {
