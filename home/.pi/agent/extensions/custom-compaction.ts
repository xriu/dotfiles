...
const SYSTEM_PROMPT = `You are a conversation summarizer. Create a comprehensive summary of this conversation that captures:
...
Format the summary as structured markdown with clear sections. Output only the summary, without any preamble.`;
...
export default function (pi: ExtensionAPI) {
	pi.on("session_before_compact", async (event, ctx) => {
		...
		// Keep instructions separate from the conversation, as /handoff does.
