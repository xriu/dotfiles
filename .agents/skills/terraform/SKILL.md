---
name: terraform
description: Expert guidance for Terraform and Infrastructure as Code on AWS, Azure, and GCP
---

## What I do

- Provide expert guidance on Terraform and Infrastructure as Code (IaC) for AWS, Azure, and GCP
- Write concise, well-structured Terraform code with accurate examples
- Organize infrastructure resources into reusable modules
- Apply security best practices and state management strategies

## When to use me

Use this skill when you need help with:
- Writing or reviewing Terraform configurations
- Designing modular, reusable infrastructure code
- Setting up remote backends and state management
- Implementing security practices for cloud resources
